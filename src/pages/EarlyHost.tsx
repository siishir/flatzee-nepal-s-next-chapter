  ...
  const benefits = [
    {
      ...
      title: "0% Commission",
      description: "Zero commission for the first 3 months after launch"
    },
    {
      icon: <Zap className="w-6 h-6" />,
      title: "Reduced Rates",
      description: "Discounted commission rates afterward as an early partner"
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: "Priority Support",
      description: "Priority onboarding and dedicated support team"
    },
    {
      icon: <Shield className="w-6 h-6" />,
      title: "Early Access",
      description: "Get your listings live before the public launch"
    }
  ];
